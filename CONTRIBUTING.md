Contributing to Bitnet Core
============================

The Bitnet Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Bitnet Core
...
Before you start contributing, familiarize yourself with the Bitnet Core build
system and tests. Refer to the documentation in the repository on how to build
Bitnet Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Bitnet Core PR Review Club](https://bitnetcore.reviews/) meeting.
...
Most communication about Bitnet Core development happens on IRC, in the
...
fork of Bitnet Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Bitnet Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitnet
Network Protocol consensus changes.

Whether a pull request is merged into Bitnet Core rests with the project merge
maintainers.
...
Patches that change Bitnet consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitnet consensus, it must have been
