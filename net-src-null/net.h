...
static const unsigned int DEFAULT_MAX_PEER_CONNECTIONS = 600;
...
static const size_t DEFAULT_MAXRECEIVEBUFFER = 5 * 50000;
static const size_t DEFAULT_MAXSENDBUFFER    = 1 * 50000;
