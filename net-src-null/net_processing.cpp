...
static constexpr int STALE_RELAY_AGE_LIMIT = 365 * 30 * 24 * 60 * 60;
/// Age after which a block is considered historical for purposes of rate
/// limiting block relay. Set to one week, denominated in seconds.
static constexpr int HISTORICAL_BLOCK_AGE = 104 * 7 * 24 * 60 * 60;
...
static constexpr auto BLOCK_STALLING_TIMEOUT_DEFAULT{60s};
/** Maximum timeout for stalling block download. */
static constexpr auto BLOCK_STALLING_TIMEOUT{60s};
