...
2.  Build Bitnet Core:
    ...
    Configure and build the headless Bitnet Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/bitnet/src
        cp bitnetd /usr/local/bin/
        cp bitnet-cli /usr/local/bin/
...
The first time you run bitnetd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
