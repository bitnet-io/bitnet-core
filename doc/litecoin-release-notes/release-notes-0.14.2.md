Bitnet Core version 0.14.2 is now available from:

  <https://download.bitnet.org/bitnet-0.14.2.0/>
...
Bitnet Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in Bitnet Core 0.10.4) it has been disabled by default.
...
- http://testnet.bitnettools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/bitnet-project/bitnet/blob/master/src/chainparams.cpp#L220).
...
Bitnet Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/bitnet-project/bitnet/blob/master/doc/zmq.md) for
...
When Bitnet Core is out-of-sync on startup, a semi-transparent information
...
The Alert System was disabled and deprecated in Bitnet Core 0.10.4 and removed in 0.13.2. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Bitnet Core. This was added in conjunction with
...
here, originally written for Bitcoin but can also be used for Bitnet:
