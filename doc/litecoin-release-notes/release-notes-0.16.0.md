Bitnet Core version 0.16.0 is now available from:

  <https://download.bitnet.org/bitnet-0.16.0/>
...
Bitnet Core now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile Bitnet Core is now 4.8. No effort will be
...
- #482 `5c8e26d` Bitnet: Basic changes for v0.16 release (thrasher-)
