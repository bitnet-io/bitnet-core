# Fuzzing Bitnet Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Bitnet Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
## Overview of Bitnet Core fuzzing

[Google](https://github.com/google/fuzzing/) has a good overview of fuzzing in general, with contributions from key architects of some of the most-used fuzzers. [This paper](https://agroce.github.io/bitnet_report.pdf) includes an external overview of the status of Bitnet Core fuzzing, as of summer 2021.  [John Regehr](https://blog.regehr.org/archives/1687) provides good advice on writing code that assists fuzzers in finding bugs, which is useful for developers to keep in mind.
...
Every single pull request submitted against the Bitnet Core repo is automatically tested against all inputs in the [`bitnet-core/qa-assets`](https://github.com/bitnet-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Bitnet Core more robust.
...
with certain assembly code from Bitnet Core's code. See [developer notes on sanitizers](https://github.com/bitnet/bitnet/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Bitnet Core using afl++

## Quickstart guide

To quickly get started fuzzing Bitnet Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Bitnet Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Bitnet Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
## Fuzzing the Bitnet Core P2P layer using Honggfuzz NetDriver

Honggfuzz NetDriver allows for very easy fuzzing of TCP servers such as Bitnet
...
# Fuzzing Bitnet Core using Eclipser (v1.x)

## Quickstart guide

To quickly get started fuzzing Bitnet Core using [Eclipser v1.x](https://github.com/SoftSec-KAIST/Eclipser/tree/v1.x):
...
Bitnet Core participates in Google's [OSS-Fuzz](https://github.com/google/oss-fuzz/tree/master/projects/bitnet-core)
...
because Bitnet is a live P2P network, and not just standalone local software,
