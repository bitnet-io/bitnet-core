Bitnet Core version 1.14.2 is now available from:

  <https://github.com/bitnet/bitnet/releases/tag/v1.14.2/>
...
Bitnet Core introduces pruning the blockchain in 1.14. Pruning
...
Since 1.14.0 the approximate transaction fee shown in Bitnet-Qt when using coin
