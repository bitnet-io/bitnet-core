...
Bitnet Core version 0.20.0 is now available from:
...
#### Removal of BIP61 reject network messages from Bitnet Core

The `-enablebip61` command line option to enable BIP61 has been removed.
(#17004)

This feature has been disabled by default since Bitnet Core version 0.18.0.
...
- Testing or debugging of implementations of the Bitnet P2P network protocol
  should be done by inspecting the log messages that are produced by a recent
  version of Bitnet Core. Bitnet Core logs debug messages
...
- OpenSSL is no longer used by Bitnet Core.  (#17265)

- BIP70 support has been fully removed from Bitnet Core. The
...
- All custom settings configured when Bitnet Core starts are now
...
- The "Start Bitnet Core on system login" option has been removed on macOS.
  (#17567)
...
- A "known bug" [announced](https://bitnetcore.org/en/releases/0.18.0/#wallet-gui)
  ...
  affected anyone who simultaneously used multiple Bitnet Core wallets
...
- For watch-only wallets, creating a new transaction in the Send screen
  ...
  automatically copy a Partially-Signed Bitnet Transaction (PSBT) to
  the system clipboard.  This can then be pasted into an external
  program such as [HWI](https://github.com/bitnet-core/HWI) for
  signing.  Future versions of Bitnet Core should support a GUI option
...
- Bitnet Core's automatically-generated source code documentation is
...
- #16983 Add detailed info about Bitnet Core files (hebasto)
