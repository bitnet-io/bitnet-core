Bitnet Core version 0.12.0 is now available from:
...
installer (on Windows) or just copy over /Applications/Bitnet-Qt (on Mac) or
...
backwards-compatible with pre-0.10 versions of Bitnet Core or other software:
...
pre-0.12 versions of Bitnet Core or other software.

If you want to downgrade after you have done a reindex with 0.12.0 or later,
you will need to reindex when you first start Bitnet Core version 0.11 or
earlier.
...
Bitnet Core 0.12 will have a strict maximum size on the mempool. The
...
Bitnet Core 0.12 also introduces new default policy limits on the length and
...
Bitnet Core 0.12 nodes. Bitnet Core will only allow replacement of
...
Note that the wallet in Bitnet Core 0.12 does not yet have support for
...
In Bitnet Core 0.12, when mempool limit has been reached a higher minimum
...
- #6214 `87406aa` [OSX] revert renaming of Bitnet-Qt.app and use CFBundleDisplayName (partial revert of #6116) (Jonas Schnelli)
