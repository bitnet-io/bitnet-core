...
Bitnet Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- BitnetMiner : Generates bitnets (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:bitnet/bitnet.git
