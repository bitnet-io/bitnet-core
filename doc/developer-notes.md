...
Bitnet Core uses [Doxygen](https://www.doxygen.nl/) to generate its official documentation.
...
Some of these are maintained by active developers of Bitnet Core, in which case
...
a Bitnet Core subtree, so that they can be integrated quickly. Cosmetic changes
...
compatibility between nodes. This happened in Bitnet 0.8 (when LevelDB was
