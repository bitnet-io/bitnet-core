# Support for Output Descriptors in Bitnet Core

Since Bitnet Core v0.17, there is support for Output Descriptors. This is a
...
on Bitnet's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Bitnet Core descriptor wallet to serve as your
...
existing Bitnet Core wallets, a convenience function `combo` is
...
All RPCs in Bitnet Core will include the checksum in their output. Only
