...
Tracing (USDT) support for Bitnet Core on Linux using. For more information on
USDT support in Bitnet Core see the [USDT documentation].
...
[Bitnet Core USDT documentation] on how to list available tracepoints in your
`bitnetd` binary.

[Bitnet Core USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
Bitnet P2P messages can be larger than 32kb (e.g. `tx`, `block`, ...). The
...
In a different terminal, starting Bitnet Core in SigNet mode and with
re-indexing enabled.
