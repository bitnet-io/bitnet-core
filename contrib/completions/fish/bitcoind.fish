...
complete --command bitnetd --no-files

# Extract options
function __fish_bitnetd_get_options
...
complete \
    --command bitnetd \
    --arguments "(__fish_bitnetd_get_options --nofiles)"
