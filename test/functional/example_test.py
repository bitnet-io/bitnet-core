...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitnetTestFramework
    pass


class ExampleTest(BitnetTestFramework):
    # Each functional test is a subclass of the BitnetTestFramework class.
    ...
    def custom_method(self):
        ...
        BitnetTestFramework class so other tests can use it."""
