...
---------|--------------------
Linux    | `$HOME/.bitnet/`
macOS    | `$HOME/Library/Application Support/Bitnet/`
Windows  | `%APPDATA%\Bitnet\` <sup>[\[1\]](#note1)</sup>
...
`blocks/`          | `blkNNNNN.dat`<sup>[\[2\]](#note2)</sup> | Actual Bitnet blocks (in network format, dumped in raw on disk, 128 MiB per file)
