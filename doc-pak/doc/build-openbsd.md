...
...
to: /path/to/bitnet/depends/x86_64-unknown-openbsd
```

Then set `BDB_PREFIX`:

```bash
export BDB_PREFIX="/path/to/bitnet/depends/x86_64-unknown-openbsd"
```
...
(see issue [#6658](https://github.com/bitnet/bitnet/issues/6658)).
