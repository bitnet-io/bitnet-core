# PSBT Howto for Bitnet Core

Since Bitnet Core 0.17, an RPC interface exists for Partially Signed Bitnet
...
PSBT is an interchange format for Bitnet transactions that are not fully signed
...
#### Multisig with multiple Bitnet Core instances
...
Bitnet Core. We assume their wallets only contain the multisig funds. In case
