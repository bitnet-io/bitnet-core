...
Bitnet Core 1.8.1 is primarily a bugfix release, bringing Bitnet Core in
line with Bitcoin 0.9.3. Bitnet Core 1.8.1 also adds in support for printing
...
* Disable Transifex based translation process (not used by Bitnet Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Bitnet Core clients
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/bitnet/bitnet/issues/134).
