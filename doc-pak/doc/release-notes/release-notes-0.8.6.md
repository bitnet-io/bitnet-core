Bitnet-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitnet/files/Bitnet/bitnet-0.8.6/
...
- Fix Bitnet-Qt startup crash when clicking dock icon on OSX 
