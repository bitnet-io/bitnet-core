Bitnet Core version 0.13.0 is now available from:
...
proposed parameters, a future release of Bitnet Core is expected that
...
- #8207 `f7a403b` Add a link to the Bitnet-Core repository and website to the About Dialog (MarcoFalke)
...
- #8164 `0f24eaf` [Bitnet-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
