Bitnet version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitnet/files/Bitnet/bitnet-0.5.4/
...
Fix Bitnet-Qt notifications under Growl 1.3.
Increase required age of Bitnet-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitnet properly when installing Bitnet-Qt over it. (Windows)
