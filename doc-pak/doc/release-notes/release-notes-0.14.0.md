Bitnet Core version 0.14.0 is now available from:
...
Bitnet Core has supported automatically pruning the blockchain since 0.11. Pruning
...
The Alert System was [disabled and deprecated](https://bitnet.org/en/alert/2016-11-01-alert-retirement) in Bitnet Core 0.12.1 and removed in 0.13.0. 
