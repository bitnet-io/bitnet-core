Bitnet version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bitnet/files/Bitnet/bitnet-0.7.0/

We recommend that everybody running prior versions of bitnetd/Bitnet-Qt
...
Bitnet Improvement Proposals implemented
