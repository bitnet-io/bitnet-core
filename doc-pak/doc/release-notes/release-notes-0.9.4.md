Bitnet Core version 0.9.4 is now available from:
...
this update is incompatible with the Bitnet system and could lead to consensus
forks.

Bitnet Core released binaries from https://bitnet.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitnet/+archive/ubuntu/bitnet
- A third-party or self-compiled Bitnet Core

upgrade to Bitnet Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
