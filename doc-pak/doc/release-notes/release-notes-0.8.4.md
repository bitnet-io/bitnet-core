Bitnet-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitnet/files/Bitnet/bitnet-0.8.4/
...
code, causing the Bitnet-Qt or bitnetd process to crash.
...
their own version of Bitnet against Boost versions 1.50-1.52.
