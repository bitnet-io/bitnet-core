Bitnet Core version 0.18.0 is now available from:
...
- The `whitelistforcerelay` option is used to relay transactions from
  ...
  [contacting](https://bitnetcore.org/en/contact/) the Bitnet Core
...
`~bitnet/.bitnet`. This change makes Bitnet Core more consistent with
...
- Since version 0.16.0, Bitnet Core’s built-in wallet has defaulted to
  ...
  addresses in Bitnet Core 0.19 (approximately November 2019).
...
- #11625 Add BitnetApplication & RPCConsole tests (ryanofsky)
...
- #11526 Visual Studio build configuration for Bitnet Core (sipsorcery)
...
- #12775 Integration of property based testing into Bitnet Core (Christewart)
