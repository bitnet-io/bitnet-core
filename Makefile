...
ACLOCAL = ${SHELL} /home/c4pt/opt/BITNET-IO/bitnet-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /home/c4pt/opt/BITNET-IO/bitnet-core/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
