...
static constexpr auto HEADERS_DOWNLOAD_TIMEOUT_PER_HEADER = 100ms;
...
static constexpr auto EXTRA_PEER_CHECK_INTERVAL{60s};
...
static constexpr int STALE_RELAY_AGE_LIMIT = 7 * 24 * 60 * 60;
/// Age after which a block is considered historical for purposes of rate
/// limiting block relay. Set to one week, denominated in seconds.
static constexpr int HISTORICAL_BLOCK_AGE =  7 * 24 * 60 * 60;
/** Time between pings automatically sent out for latency probing and keepalive */
static constexpr auto PING_INTERVAL{20min};
...
static constexpr auto BLOCK_STALLING_TIMEOUT_DEFAULT{900s};
/** Maximum timeout for stalling block download. */
static constexpr auto BLOCK_STALLING_TIMEOUT{900s};
...
static const unsigned int NODE_NETWORK_LIMITED_MIN_BLOCKS = 127000;
...
static constexpr auto INBOUND_INVENTORY_BROADCAST_INTERVAL{10s};
...
static constexpr uint32_t MAX_GETCFILTERS_SIZE = 20000;
/** Maximum number of cf hashes that may be requested with one getcfheaders. See BIP 157. */
static constexpr uint32_t MAX_GETCFHEADERS_SIZE = 40000;
