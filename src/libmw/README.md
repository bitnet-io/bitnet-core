...
Modular library for supporting Bitnet's implementation of the MWEB (Mimblewimble Extension Block). 
...
### crypto/
Crypto libraries not provided by bitnet or secp256k1-zkp.
...
While boost\:\:filesystem is already pulled in by bitnet, I was uncomfortable with its API and its handling of unicode conversions.
...
and just replace the more-limited secp256k1 dependency that's already included in Bitnet.
