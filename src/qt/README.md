This directory contains the source code for the Bitnet Core graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
* UI elements like BitnetAmountField, which inherit from QWidget.
...
9. You're all set! Start developing, building, and debugging the Bitnet Core GUI
