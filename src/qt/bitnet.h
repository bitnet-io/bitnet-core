...
/** Main Bitnet application object */
class BitnetApplication: public QApplication
{
    Q_OBJECT
public:
    explicit BitnetApplication();
    ~BitnetApplication();
    ...
    /// Get window identifier of QMainWindow (BitnetGUI)
...
Q_SIGNALS:
    ...
    void windowShown(BitnetGUI* window);
