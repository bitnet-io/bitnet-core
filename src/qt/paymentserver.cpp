...
const char* BIP71_MIMETYPE_PAYMENT = "application/bitnet-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bitnet-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bitnet-paymentrequest";
#endif
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Bitnet address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
