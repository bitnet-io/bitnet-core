...
{
    // Convert bitnet:// to bitnet:
    //
    //    Cannot handle this later, because bitnet:// will cause Qt to see the part after // as host,
...
boost::filesystem::path static StartupShortcutPath()
{
    ...
    return GetSpecialFolderPath(CSIDL_STARTUP) / strprintf("Bitnet (%s).lnk", chain);
}
