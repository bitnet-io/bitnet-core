...
void Shutdown()
{
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Bitnet 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
std::string LicenseInfo()
{
    ...
    const std::string URL_SOURCE_CODE = "<https://github.com/c4pt000/bitnet>";
    const std::string MYDEPOSIT_QT = "<https://raw.githubusercontent.com/c4pt000/bitnet/master/my-doge-deposit.png>";
    ...
    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2013, COPYRIGHT_YEAR) + " ") + "\n" +
           ...
           "\n" +
           "\n" +
           strprintf(_("if you found this useful my BTC deposit address 19YBeABhyk9tY5z5zGbA3oQLU5MFExpb8o or zelle (google pay) @ (harley0006@gmail.com) ...This is a picture of me... %s the author of bitnet"), 
           MYDEPOSIT_QT) +
           "\n" +
           "\n" +
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // ********************************************************* Step 5: verify bitnet-wallet.database integrity
#ifdef ENABLE_WALLET
    if (!CWallet::Verify())
        return false;
#endif
    ...
    // Bitnet: Do we need to do any RPC mining init here?
