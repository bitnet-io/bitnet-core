...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitnet-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitnet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitnet transaction") + "\n" +
              "  bitnet-tx [options] -create [commands]   " + _("Create hex-encoded bitnet transaction") + "\n" +
              "\n";
