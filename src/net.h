...
static const int MAX_OUTBOUND_FULL_RELAY_CONNECTIONS = 15;
/** Maximum number of addnode outgoing nodes */
static const int MAX_ADDNODE_CONNECTIONS = 15;
...
static const unsigned int DEFAULT_MAX_PEER_CONNECTIONS = 325;
